...
//This is the CSS part of PDF, make sure that it is same as the preview CSS- for this one it should be similar to templateB.css
//following is almost similar to css file, while creating original templates please note above point
const styles = StyleSheet.create({
  page: {
    flexDirection: 'column',
    backgroundColor: 'rgb(96, 3, 3)',
    margin:'0px',
    width: '100%',
    color:'white'
  },
